...
-- ⛔ THE SORT IS ON THE BIT, NOT THE STRING. A collation that files punctuation
--   after letters buries the split this query exists to show, so the `none` bit is
--   pulled out and ordered explicitly.

...
SELECT * FROM (VALUES
  ('refusal_as_decay',
   ...
   'steady'),
  ('experienced_or_not',
   'customer <-> unrealised, where a layer names only one of the two',
...
-- layers/stated_zero_exposure.sqlc: exactly the population the unserved rules examine.
WITH shortfall AS (
